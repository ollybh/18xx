    ...
    module G1807
      module Trains
        ...
        STATUS_TEXT = Base::STATUS_TEXT.merge(
          ...
          'float_public' => ['Start public companies',
                             'Public companies may be started by buying the president’s certificate.'],
        ...
        PHASES = [
          ...
          },
          {
            ...
            tiles: %i[yellow green],
            status: %w[minors_start can_buy_companies minors_convert float_public train_export],
            on: '4',
            operating_rounds: 2,
          },
          {
            ...
            status: %w[can_buy_companies minors_convert float_public train_export],
            on: %w[5 3G],
            operating_rounds: 2,
          },
          {
            ...
            tiles: %i[yellow green brown],
            status: %w[can_buy_companies minors_convert float_public systems_form train_export],
            on: %w[6 4G],
            operating_rounds: 2,
          },
          {
          ...
          },
          {
            ...
            tiles: %i[yellow green brown gray],
            status: %w[can_buy_companies minors_convert float_public systems_form double_jump],
            on: %w[4+4 6G],
            operating_rounds: 2,
          },
        ].freeze
