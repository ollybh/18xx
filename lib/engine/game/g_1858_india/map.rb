    ...
    module G1858India
      module Map
        ...
        HEXES = {
          white: {
            %w[A6] =>
                    ...
                    'icon=image:1858_india/LP,sticky:1;',
            %w[A8] =>
            ...
            %w[D13] =>
                    ...
                    'border=type:province,edge:2;' \
                    'border=type:province,edge:4;' \
                    'icon=image:1858_india/MB,sticky:1;',
            %w[D15] =>
                    'upgrade=cost:120,terrain:mountain;' \
                    'border=type:province,edge:0;' \
                    'border=type:province,edge:1;',
            ...
            %w[F17] =>
                    ...
                    'border=type:province,edge:2;' \
                    'border=type:province,edge:3;' \
                    'icon=image:1858_india/G,sticky:1;',
            %w[F19] =>
                    'upgrade=cost:40,terrain:mountain;' \
                    'border=type:province,edge:2;' \
                    'border=type:province,edge:3;' \
            ...
            %w[F23] =>
                    ...
                    'border=type:province,edge:4;' \
                    'border=type:province,edge:5;' \
                    'icon=image:1858_india/DS,sticky:1;',
            %w[F25] =>
                    'town=revenue:0;' \
                    'upgrade=cost:40,terrain:river;' \
                    'border=type:province,edge:1;',
            ...
            %w[P11] =>
                    ...
                    'border=type:province,edge:2;' \
                    'border=type:province,edge:3;' \
                    'icon=image:1858_india/C,sticky:1;',
            %w[P13] =>
                    'city=revenue:0;' \
                    'border=type:province,edge:2;' \
        ...
        TOKEN_DISTANCES = {
          ...
          'G2' => {
            'A6'  => 2, 'B7'  => 1, 'C8'  => 1, 'D5'  => 1, 'E12' => 1, 'G2'  => 0, 'F9'  => 1,
            'F13' => 2, 'F15' => 2, 'G16' => 2, 'G20' => 3, 'I22' => 3, 'H25' => 4, 'J13' => 3,
            'H7'  => 1, 'K6'  => 2, 'L13' => 3, 'O14' => 3, 'P13' => 3, 'O10' => 3, 'O12' => 3
          },
          'F9' => {
            'A6'  => 2, 'B7'  => 1, 'C8'  => 1, 'D5'  => 1, 'E12' => 1, 'G2'  => 1, 'F9'  => 0,
            'F13' => 2, 'F15' => 2, 'G16' => 2, 'G20' => 3, 'I22' => 3, 'H25' => 4, 'J13' => 2,
            'H7'  => 1, 'K6'  => 2, 'L13' => 3, 'O14' => 3, 'P13' => 3, 'O10' => 3, 'O12' => 3
          },
          'F13' => {
            'A6'  => 2, 'B7'  => 1, 'C8'  => 1, 'D5'  => 1, 'E12' => 1, 'G2'  => 2, 'F9'  => 2,
          ...
          'G20' => {
            'A6'  => 3, 'B7'  => 2, 'C8'  => 2, 'D5'  => 2, 'E12' => 2, 'G2'  => 3, 'F9'  => 3,
