...
module Engine
  module RouteGraph
    ...
    #   end
    #
    RSpec.shared_context 'GraphWalker spec setup' do
      let(:players)    { %w[Alice] }
    ...
    RSpec.shared_examples 'a GraphWalker on converging junctions' do
      include_context 'GraphWalker spec setup'
    ...
    RSpec.shared_examples 'a GraphWalker on highly connected maps' do
      include_context 'GraphWalker spec setup'
